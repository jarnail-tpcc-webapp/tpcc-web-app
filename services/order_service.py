...
class OrderService:
    ...
    def get_order_status(
        ...
        try:
            return self.get_order_details(warehouse_id, district_id, customer_id)
        except Exception as e:
    ...
    def get_orders(
        ...
        try:
            ...
            if warehouse_id is not None:
                filters.append("o_w_id = %s")
                params.append(warehouse_id)

            if district_id is not None:
                filters.append("o_d_id = %s")
                params.append(district_id)

            if customer_id is not None:
                filters.append("o_c_id = %s")
                params.append(customer_id)

            if status:
                filters.append("o_status = %s")
            ...
            count_result = self.db.execute_query(count_query, params[:-2])  # exclude limit & offset
